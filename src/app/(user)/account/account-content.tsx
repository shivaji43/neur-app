...
import { formatPrivyId, formatUserCreationDate, formatWalletAddress } from "@/lib/utils/format"
...
export function AccountContent() {
    ...
    const avatarLabel = userData.walletAddress ? userData.walletAddress.substring(0, 2).toUpperCase() : '?'
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium">
                                                {userData.twitter ? `@${userData.twitter.username}` : formatWalletAddress(userData.walletAddress)}
                                            </p>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-1">
                                                <CopyableText text={userData.walletAddress || ''} showSolscan={true} />
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    {userData.twitter ? `@${userData.twitter.username}` : 'Not connected'}
                                                </p>
                                            </div>
                                        </div>
                                        <Button
                                            variant="outline"
                                            size="sm"
                                            onClick={userData.twitter
                                                ? () => unlinkTwitter(userData.twitter!.subject)
                                                : linkTwitter
                                            }
                                            className={cn(
                                                "min-w-[100px] text-xs",
                                                userData.twitter && "hover:bg-destructive hover:text-destructive-foreground"
                                            )}
                                        >
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Button
                                            ...
                                            className={cn(
                                                "min-w-[100px] text-xs",
                                                userData.email && "hover:bg-destructive hover:text-destructive-foreground"
                                            )}
                                        >
