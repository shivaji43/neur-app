    ...
    return (
        <>
            ...
            <div className="flex w-full items-start gap-3 flex-row-reverse">
                <div className="relative flex max-w-[85%] flex-col gap-2 items-end">
                    <div className="relative flex flex-col gap-2 rounded-2xl px-4 py-3 text-sm shadow-sm bg-primary">
                        <div
                ...
                <div className="relative mx-auto w-full max-w-3xl px-4 py-4">
                    <div className="space-y-4">
                        ...
                        <div className="relative overflow-hidden rounded-2xl bg-muted">
                            <div className="min-h-[100px] w-full resize-none border-0 bg-transparent px-4 py-[1.3rem] animate-pulse" />
