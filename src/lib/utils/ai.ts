import { Attachment, CoreAssistantMessage, CoreMessage, CoreToolMessage, Message, ToolInvocation } from "ai";
 ...
 */
export function sanitizeResponseMessages(messages: Array<CoreToolMessage | CoreAssistantMessage>) {
 ...
 */
export function convertToUIMessages(messages: Array<PrismaMessage>): Array<Message> {
