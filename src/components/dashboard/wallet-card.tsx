                ...
                <CardContent className="pt-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            {/* Fund Wallet Button */}
                            <Button onClick={() => fundWallet(wallet.publicKey, {
                                cluster: {
                                    name: 'mainnet-beta',
                                }
                            })}>
                                ...
                                {PERCENTAGE_OPTIONS.map(({ label, value }) => {
                                    ...
                                    return (
                                        <Button
                                            ...
                                            className={cn(
                                                "min-w-[60px]",
                                                amount === calculatedAmount.toFixed(4) && "bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground"
                                            )}
                            ...
                            {sendStatus === 'idle' && (
                                <>
                                    ...
                                    <Button
                                        ...
                                        disabled={isLoading || !recipientAddress || !amount || parseFloat(amount) < MIN_AMOUNT || parseFloat(amount) > (balance - TRANSACTION_FEE_RESERVE)}
                                    >
                                        {isLoading ? (
                                            <>
